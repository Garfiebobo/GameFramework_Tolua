...
{
    public static string luaDir = Application.dataPath + "/TheRediscoveryOfMan/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/TheRediscoveryOfMan/ToLua/Lua";        //tolua lua文件目录
